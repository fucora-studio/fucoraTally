  ...
  return (
    <main className="h-screen w-full justify-center items-center mx-auto flex">
      ...
      <div className="flex justify-start flex-col w-[65vw] min-[1280px]:w-[40vw] z-5 min-[1442px]:w-[30vw]">
        ...
        <Link href="/tracker" className="rounded-4xl border-none bg-[var(--color-primary-teal)] mt-5 w-[35vw] text-center p-[0.5rem] min-[1442px]:text-xl min-[700px]:p-5 min-[700px]:w-[20vw] min-[1280px]:w-[10vw]">Get Started</Link>
      </div>
    </main>
  );
}
